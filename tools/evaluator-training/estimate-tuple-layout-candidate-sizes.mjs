...
const representativeWeights = flattenRepresentativeWeights(RUNTIME_TUPLE_RESIDUAL_PROFILE);
...
const summary = {
  ...
  activeEvaluationProfileName: RUNTIME_EVALUATION_PROFILE?.name ?? null,
  activeMoveOrderingProfileName: RUNTIME_MOVE_ORDERING_PROFILE?.name ?? null,
  activeTupleResidualProfileName: RUNTIME_TUPLE_RESIDUAL_PROFILE?.name ?? null,
  activeMpcProfileName: RUNTIME_MPC_PROFILE?.name ?? null,
  candidates,
};
