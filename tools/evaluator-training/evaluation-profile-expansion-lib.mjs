...
export function buildEvaluationExpansionSeedProfile(candidate = {}, { baseProfile = RUNTIME_EVALUATION_PROFILE } = {}) {
  const resolvedBaseProfile = compileEvaluationProfile(baseProfile ?? RUNTIME_EVALUATION_PROFILE);
