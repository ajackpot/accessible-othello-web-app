...
import { RUNTIME_EVALUATION_PROFILE, DEFAULT_EVALUATION_PROFILE, EVALUATION_FEATURE_KEYS } from '../../js/ai/evaluation-profiles.js';
...
const candidateProfile = loadJsonFileIfPresent(candidateProfilePath) ?? RUNTIME_EVALUATION_PROFILE ?? null;
