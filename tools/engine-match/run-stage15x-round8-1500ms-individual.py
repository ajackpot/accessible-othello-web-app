...
OUT_DIR = REPO / 'tools' / 'engine-match' / 'out' / '_stage15x_restart_round8_1500ms_individual'
...
def run_one(variant, scenario):
    ...
    out_json_rel = f"tools/engine-match/out/_stage15x_restart_round8_1500ms_individual/results/{run_id}.json"
...
def main():
    ...
    aggregate_json = OUT_DIR / 'stage15x_restart_round8_1500ms_aggregate.json'
    aggregate_csv = OUT_DIR / 'stage15x_restart_round8_1500ms_aggregate.csv'
    summary_md = OUT_DIR / 'stage15x_restart_round8_1500ms_summary.md'
    manifest_json = OUT_DIR / 'stage15x_restart_round8_1500ms_manifest.json'
    ...
    lines = []
    lines.append('# Stage15x restart round 8: 1500ms noisy confirmation')
    lines.append('')
    ...
    lines.append('- Variants: `active`, `s154-main + s158-stable-zebra-open`, `s154-both`, `s154-main`.')
    lines.append('')
