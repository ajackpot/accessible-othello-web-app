...
function printUsage() {
  ...
  node tools/engine-match/benchmark-profile-variant-pair.mjs \
    ...
    [--first-label active] [--first-generated-module js/ai/learned-eval-profile.generated.js] [--first-engine-options-json <file>] \
    [--second-label balanced12] [--second-generated-module tools/engine-match/fixtures/stage135-evaluation-profile-finalists/balanced12-alllate-smoothed-stability-090/learned-eval-profile.generated.js] [--second-engine-options-json <file>] \
...
const secondGeneratedModule = typeof args['second-generated-module'] === 'string' && args['second-generated-module'].trim() !== ''
  ...
  : null;
const firstEngineOptionsJson = typeof args['first-engine-options-json'] === 'string' && args['first-engine-options-json'].trim() !== ''
  ? args['first-engine-options-json'].trim()
  : null;
const secondEngineOptionsJson = typeof args['second-engine-options-json'] === 'string' && args['second-engine-options-json'].trim() !== ''
  ? args['second-engine-options-json'].trim()
  : null;
...
const firstVariant = await loadProfileVariant({
  ...
  engineOptionsJson: firstEngineOptionsJson,
});
const secondVariant = await loadProfileVariant({
  label: secondLabel,
  generatedModule: secondGeneratedModule,
  engineOptionsJson: secondEngineOptionsJson,
});
...
const finalSummary = {
  ...
  options: {
    ...
    styleKey,
    progressEveryPairs,
    firstEngineOptionsJson,
    secondEngineOptionsJson,
  },
  variants: {
