...
function withRuntimeMpcProfile(options = {}) {
  if (options && Object.hasOwn(options, 'mpcProfile')) {
    return options;
  }

  return {
    ...(options ?? {}),
    mpcProfile: RUNTIME_MPC_PROFILE ?? null,
  };
}
...
export class EngineClient {
  ...
  async search(state, options) {
    ...
    if (!this.workerAvailable) {
      return this.localEngine.findBestMove(state, withRuntimeMpcProfile(options));
    }
