...
export function summarizeResult(result, state, seed = null, extra = {}) {
  return {
    ...
    etcPreparedChildTableReuseLookups: result.stats?.etcPreparedChildTableReuseLookups ?? null,
    etcPreparedChildTableReuseHits: result.stats?.etcPreparedChildTableReuseHits ?? null,
    ...
    optimizedFewEmpties5Calls: result.stats?.optimizedFewEmpties5Calls ?? null,
    optimizedFewEmpties6Calls: result.stats?.optimizedFewEmpties6Calls ?? null,
    optimizedFewEmpties7Calls: result.stats?.optimizedFewEmpties7Calls ?? null,
    optimizedFewEmpties8Calls: result.stats?.optimizedFewEmpties8Calls ?? null,
    lightweightFewEmpties5Calls: result.stats?.lightweightFewEmpties5Calls ?? null,
    lightweightFewEmpties6Calls: result.stats?.lightweightFewEmpties6Calls ?? null,
    lightweightFewEmpties7Calls: result.stats?.lightweightFewEmpties7Calls ?? null,
    lightweightFewEmpties8Calls: result.stats?.lightweightFewEmpties8Calls ?? null,
    optimizedFewEmptiesFastestFirstSorts: result.stats?.optimizedFewEmptiesFastestFirstSorts ?? null,
    optimizedFewEmptiesFastestFirstPassCandidates: result.stats?.optimizedFewEmptiesFastestFirstPassCandidates ?? null,
    specializedFewEmptiesWldCalls: result.stats?.specializedFewEmptiesWldCalls ?? null,
    specializedFewEmptiesWld1Calls: result.stats?.specializedFewEmptiesWld1Calls ?? null,
    specializedFewEmptiesWld2Calls: result.stats?.specializedFewEmptiesWld2Calls ?? null,
    specializedFewEmptiesWld3Calls: result.stats?.specializedFewEmptiesWld3Calls ?? null,
    specializedFewEmptiesWld4Calls: result.stats?.specializedFewEmptiesWld4Calls ?? null,
    optimizedFewEmptiesWld5Calls: result.stats?.optimizedFewEmptiesWld5Calls ?? null,
    optimizedFewEmptiesWld6Calls: result.stats?.optimizedFewEmptiesWld6Calls ?? null,
    optimizedFewEmptiesWld7Calls: result.stats?.optimizedFewEmptiesWld7Calls ?? null,
    optimizedFewEmptiesWld8Calls: result.stats?.optimizedFewEmptiesWld8Calls ?? null,
    lightweightFewEmptiesWld5Calls: result.stats?.lightweightFewEmptiesWld5Calls ?? null,
    lightweightFewEmptiesWld6Calls: result.stats?.lightweightFewEmptiesWld6Calls ?? null,
    lightweightFewEmptiesWld7Calls: result.stats?.lightweightFewEmptiesWld7Calls ?? null,
    lightweightFewEmptiesWld8Calls: result.stats?.lightweightFewEmptiesWld8Calls ?? null,
    optimizedFewEmptiesWldFastestFirstSorts: result.stats?.optimizedFewEmptiesWldFastestFirstSorts ?? null,
    optimizedFewEmptiesWldFastestFirstPassCandidates: result.stats?.optimizedFewEmptiesWldFastestFirstPassCandidates ?? null,
    ...
    optimizedFewEmptiesExactSolverEmpties: result.options?.optimizedFewEmptiesExactSolverEmpties ?? null,
    lightweightFewEmptiesExactMovePath: result.options?.lightweightFewEmptiesExactMovePath ?? null,
    optimizedFewEmptiesWldSolverEmpties: result.options?.optimizedFewEmptiesWldSolverEmpties ?? null,
    lightweightFewEmptiesWldMovePath: result.options?.lightweightFewEmptiesWldMovePath ?? null,
