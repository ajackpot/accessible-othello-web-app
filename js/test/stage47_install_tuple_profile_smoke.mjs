...
try {
  ...
  assert.equal(imported.GENERATED_EVALUATION_PROFILE?.name ?? null, RUNTIME_EVALUATION_PROFILE?.name ?? null);
  assert.equal(imported.GENERATED_MOVE_ORDERING_PROFILE?.name ?? null, RUNTIME_MOVE_ORDERING_PROFILE?.name ?? null);
  assert.equal(imported.GENERATED_MPC_PROFILE?.name ?? null, RUNTIME_MPC_PROFILE?.name ?? null);
  ...
  assert.equal(summary.evaluationProfileName ?? null, RUNTIME_EVALUATION_PROFILE?.name ?? null);
  assert.equal(summary.moveOrderingProfileName ?? null, RUNTIME_MOVE_ORDERING_PROFILE?.name ?? null);
