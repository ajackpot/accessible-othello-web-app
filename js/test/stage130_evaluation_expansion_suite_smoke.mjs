...
import { RUNTIME_EVALUATION_PROFILE, DEFAULT_EVALUATION_FEATURE_KEYS } from '../ai/evaluation-profiles.js';
...
const evaluator = new Evaluator({ evaluationProfile: RUNTIME_EVALUATION_PROFILE });
...
try {
  ...
  assert.ok(smoothedProfile.featureKeys.length > (RUNTIME_EVALUATION_PROFILE.featureKeys?.length ?? DEFAULT_EVALUATION_FEATURE_KEYS.length));
