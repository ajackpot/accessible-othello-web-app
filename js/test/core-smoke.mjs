...
function runEvaluatorTests() {
  ...
  assert.equal(safeFeatures.edgePattern, 0, 'Retired handcrafted edge-pattern feature should stay disabled in runtime diagnostics.');
  assert.equal(safeFeatures.cornerPattern, 0, 'Retired handcrafted corner-pattern feature should stay disabled in runtime diagnostics.');
  ...
  assert.equal(riskyFeatures.edgePattern, 0, 'Retired handcrafted edge-pattern feature should stay disabled on risky positions too.');
  assert.equal(riskyFeatures.cornerPattern, 0, 'Retired handcrafted corner-pattern feature should stay disabled on risky positions too.');
...
function runSearchTests() {
  ...
  assert.equal(
    ...
    'The move-ordering evaluator should surface whichever trained child bucket actually covers thirteen empties in the installed runtime profile.',
  );
