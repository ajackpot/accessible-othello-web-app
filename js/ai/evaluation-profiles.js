import * as GENERATED_PROFILES_MODULE from './learned-eval-profile.generated.js';
import {
  resolvePatternBankProfileStack,
...
const GENERATED_EVALUATION_PROFILE = GENERATED_PROFILES_MODULE.default ?? GENERATED_PROFILES_MODULE.GENERATED_EVALUATION_PROFILE ?? null;
const GENERATED_MOVE_ORDERING_PROFILE = GENERATED_PROFILES_MODULE.GENERATED_MOVE_ORDERING_PROFILE ?? null;
const GENERATED_MPC_PROFILE = GENERATED_PROFILES_MODULE.GENERATED_MPC_PROFILE ?? null;
const GENERATED_TUPLE_RESIDUAL_PROFILE = GENERATED_PROFILES_MODULE.GENERATED_TUPLE_RESIDUAL_PROFILE ?? null;
const GENERATED_PATTERN_BANK_PROFILES = GENERATED_PROFILES_MODULE.GENERATED_PATTERN_BANK_PROFILES
  ?? GENERATED_PROFILES_MODULE.GENERATED_PATTERN_BANK_PROFILE
  ?? null;
const GENERATED_MOVE_ORDERING_PATTERN_BANK_PROFILES = GENERATED_PROFILES_MODULE.GENERATED_MOVE_ORDERING_PATTERN_BANK_PROFILES
  ?? GENERATED_PROFILES_MODULE.GENERATED_MOVE_ORDERING_PATTERN_BANK_PROFILE
  ?? null;
...
export const RUNTIME_EVALUATION_PROFILE = GENERATED_EVALUATION_PROFILE ?? DEFAULT_EVALUATION_PROFILE;
export const RUNTIME_MOVE_ORDERING_PROFILE = GENERATED_MOVE_ORDERING_PROFILE ?? null;
export const RUNTIME_TUPLE_RESIDUAL_PROFILE = GENERATED_TUPLE_RESIDUAL_PROFILE ?? null;
export const RUNTIME_MPC_PROFILE = GENERATED_MPC_PROFILE ?? null;
export const RUNTIME_PATTERN_BANK_PROFILES = resolvePatternBankProfileStack(GENERATED_PATTERN_BANK_PROFILES);
export const RUNTIME_PATTERN_BANK_PROFILE = RUNTIME_PATTERN_BANK_PROFILES?.[0] ?? null;
export const RUNTIME_MOVE_ORDERING_PATTERN_BANK_PROFILES = resolvePatternBankProfileStack(GENERATED_MOVE_ORDERING_PATTERN_BANK_PROFILES);
export const RUNTIME_MOVE_ORDERING_PATTERN_BANK_PROFILE = RUNTIME_MOVE_ORDERING_PATTERN_BANK_PROFILES?.[0] ?? null;

export function resolveEvaluationProfile(profile = RUNTIME_EVALUATION_PROFILE) {
...
export function compileEvaluationProfile(profile = RUNTIME_EVALUATION_PROFILE) {
...
export function resolveMoveOrderingBuckets(profile = RUNTIME_MOVE_ORDERING_PROFILE) {
...
export function resolveTupleResidualBuckets(profile = RUNTIME_TUPLE_RESIDUAL_PROFILE) {
...
export function resolveTupleResidualProfile(profile = RUNTIME_TUPLE_RESIDUAL_PROFILE) {
...
export function compileTupleResidualProfile(profile = RUNTIME_TUPLE_RESIDUAL_PROFILE) {
...
export function resolveMpcProfile(profile = RUNTIME_MPC_PROFILE) {
  if (!profile || typeof profile !== 'object') {
    return null;
  }
...
export function compileMpcProfile(profile = RUNTIME_MPC_PROFILE) {
