...
export const ACTIVE_PATTERN_BANK_PROFILES = resolvePatternBankProfileStack(GENERATED_PATTERN_BANK_PROFILES);
export const ACTIVE_PATTERN_BANK_PROFILE = ACTIVE_PATTERN_BANK_PROFILES?.[0] ?? null;
export const ACTIVE_MOVE_ORDERING_PATTERN_BANK_PROFILES = resolvePatternBankProfileStack(GENERATED_MOVE_ORDERING_PATTERN_BANK_PROFILES);
export const ACTIVE_MOVE_ORDERING_PATTERN_BANK_PROFILE = ACTIVE_MOVE_ORDERING_PATTERN_BANK_PROFILES?.[0] ?? null;
